...
public class AllPostsAdapter extends FirestoreRecyclerAdapter<Post,AllPostsAdapter.ViewHolder> {
...
public interface onViewClickListener
{
    ...
    public AllPostsAdapter(@NonNull FirestoreRecyclerOptions<Post> options) {
        super(options);
...
public class ViewHolder extends RecyclerView.ViewHolder  {
    ...
    @Override
    protected void onBindViewHolder(@NonNull AllPostsAdapter.ViewHolder holder, int position, @NonNull Post model) {
// Get element from your dataset at this position and replace the
    ...
    @NonNull
    @Override
    public AllPostsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
